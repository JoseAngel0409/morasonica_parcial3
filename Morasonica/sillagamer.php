                    ...
                    <div class="card-deck">
                        <div class="card mb-3" style="max-width: 540px;">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <img src="silla.jpeg" width="200" height="270">
                                </div>
                                <div class="col-md-10">
                                    <div class="card-body">
                                        <h5 class="card-title">Silla Gamer</h5>
                                        <p class="card-text">Nuevo| 5672 vendidos</p>
                                        ...
                                        <b class="card-text" style="color:lime">Envío gratis</b><br><br>
                        ...
                        <div class="card mb-3" style="max-width: 540px;">
                            <div class="row no-gutters">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h5 class="card-title">Tienda Oficial Tedge</h5>
                                        <p class="card-text">19,251 ventas.</p>
                                        <b class="card-text">STOCK DISPONIBLE</b>
                                        <p class="card-text"><medium class="text-muted">1000 Unidades.</medium></p><br><br><br>
