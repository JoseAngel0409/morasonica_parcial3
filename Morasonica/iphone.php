                    ...
                    <div class="card-deck">
                        <div class="card mb-3" style="max-width: 540px;">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <img src="iphone.jpeg" width="165" height="270">
                                </div>
                                <div class="col-md-10">
                                    <div class="card-body">
                                        <h5 class="card-title">Iphone 11 Pro</h5>
                                        <p class="card-text">Relanzamiento| 2991 vendidos</p>
                                        <p class="card-text">Iphone 11 Pro 256 GB Rojo.</p>
                                        <b class="card-text" >$11,425</b>
                                        <b class="card-text" style="color:lime">69% OFF</b><br><br>
                        ...
                        <div class="card mb-3" style="max-width: 540px;">
                            <div class="row no-gutters">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h5 class="card-title">Tienda Oficial VENTASLEGALES2005</h5>
                                        <p class="card-text">100 ventas.</p>
                                        <b class="card-text">STOCK DISPONIBLE</b>
                                        <p class="card-text"><medium class="text-muted">3000 Unidades.</medium></p><br><br><br>
