                    ...
                    <div class="card-deck">
                        <div class="card mb-3" style="max-width: 540px;">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <img src="rascador.jpeg" width="180" height="270">
                                </div>
                                <div class="col-md-10">
                                    <div class="card-body">
                                        <h5 class="card-title">Rascador Poste con Juguete Desmontable</h5>
                                        <p class="card-text">Nuevo| 342 vendidos</p>
                                        <p class="card-text">Rascador Poste con Juguete Desmontable Para Gatos, 63cm.</p>
                                        <b class="card-text">$6,425</b>
                                        <b class="card-text" style="color:lime">45% OFF</b><br><br>
                        ...
                        <div class="card mb-3" style="max-width: 540px;">
                            <div class="row no-gutters">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h5 class="card-title">Tienda Oficial MascotasyAccesoriosMX</h5>
                                        <p class="card-text">6,521 ventas.</p>
                                        <b class="card-text">STOCK DISPONIBLE</b>
                                        <p class="card-text"><medium class="text-muted">200 Unidades.</medium></p><br><br><br>
